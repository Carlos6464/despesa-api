...
def read_categories(
    ...
    """
    Retorna uma lista de todas as categorias pertencentes ao usuário autenticado.
    """
    service = CategoryService(db)
    return service.get_all_categories_for_user(current_user=current_user, skip=skip, limit=limit)
